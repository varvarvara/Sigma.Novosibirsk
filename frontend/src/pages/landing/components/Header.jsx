      ...
      <header className="site-header" id="top">
        <div className="container header-bar">
          ...
          <nav className="header-nav" aria-label="Основная навигация">
           <a href="#about" className={activeSection === 'about' ? 'active' : ''}>О Сигме</a>
            <a href="#history" className={activeSection === 'history' ? 'active' : ''}>История</a>
            <a href="#reviews" className={activeSection === 'reviews' ? 'active' : ''}>Отзывы</a>
            <a href="#faq" className={activeSection === 'faq' ? 'active' : ''}>FAQ</a>
            <a href="#contacts" className={activeSection === 'contacts' ? 'active' : ''}>Контакты</a>
          ...
          >
            <nav className="mobile-nav" aria-label="Мобильная навигация">
              <a  href="#about"
                  ...
                  onClick={closeMenu}>О Сигме</a>
              <a  href="#history"
                  className={activeSection === 'history' ? 'active' : ''}
                  onClick={closeMenu}>История</a>
              <a  href="#reviews"
                  className={activeSection === 'reviews' ? 'active' : ''}
                  onClick={closeMenu}>Отзывы</a>
              <a  href="#faq"
                  className={activeSection === 'faq' ? 'active' : ''}
                  onClick={closeMenu}>FAQ</a>
              <a  href="#contacts"
                  className={activeSection === 'contacts' ? 'active' : ''}
                  onClick={closeMenu}>Контакты</a>
