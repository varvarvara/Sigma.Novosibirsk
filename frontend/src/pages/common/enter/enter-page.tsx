...
import { getRoleSelectionNavigateOptions } from '../../../features/auth/auth-flow'
    ...
    <main className="welcome-page">
      ...
      <section className="welcome-page__actions">
        <button
          ...
          type="button"
          onClick={() => navigate(getRoleSelectionNavigateOptions('register'))}
        >
          Зарегистрироваться
        </button>
        <button
          ...
          type="button"
          onClick={() => navigate(getRoleSelectionNavigateOptions('login'))}
        >
          Войти
        </button>
      </section>
